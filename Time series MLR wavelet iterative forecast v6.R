...
rmse_mlr <- function(symbol,setplot=0) {
	...
	if (setplot==1){
		png(filename=paste0("c:\\ml\\MLRw_", symbol, ".png"))
	...
	write.csv(data.frame(rmse=c(r)),paste0("c:\\ml\\MLRw_", symbol, ".csv"),row.names = FALSE)

	return (r)
}

print(paste0("MLRw Tesla:",	rmse_mlr("TSLA",1)))
print(paste0("MLRw Google:", 	rmse_mlr("GOOGL",1)))
print(paste0("MLRw Nvidia:", 	rmse_mlr("NVDA",1)))
print(paste0("MLRw Apple:", 	rmse_mlr("AAPL",1)))
print(paste0("MLRw Microsoft:",	rmse_mlr("MSFT",1)))
print(paste0("MLRw Nokia:", 	rmse_mlr("NOK",1)))
print(paste0("MLRw Rheinmetall:", rmse_mlr("RHM.F",1)))
print(paste0("MLRw BAE Systems:", rmse_mlr("BA.L",1)))
print(paste0("MLRw Dassault Av.", rmse_mlr("AM.PA",1)))
print(paste0("MLRw Thalès:",	rmse_mlr("HO.PA",1)))
print(paste0("MLRw Leonardo:",	rmse_mlr("FMNB.F",1)))
